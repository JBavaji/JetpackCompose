...
class LazyColumnListActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MyTheme {
                MainLazyColumnScreen()
            }
        }
    }

    @Composable
    private fun MainLazyColumnScreen(userProfiles: List<UserProfile> = userProfileList) {
    ...
    @Composable
    private fun ProfileContent(userName: String, onlineStatus: Boolean) {
        Column(
            modifier = Modifier
                .padding(8.dp)
                .fillMaxWidth()
